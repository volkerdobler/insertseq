...
| `insertseq.language`          |  string | `""`                           | Default language for dates and validation hints/messages (`"en"`, `"de"`, or empty for automatic VS Code UI detection).                                                                                                                                                                                                         |
...
| `insertseq.previewMode`       |  string | `"ghostText"`                  | Preview style: `"ghostText"` (native theme color `editorGhostText.foreground`, italic font, no flicker, compact overflow) or `"decoration"` (classic style with custom `previewColor`).                                                                                                                                                                                                           |
| `insertseq.previewColor`      |  string | `"#888888"`                    | Color used for the preview decoration (when `insertseq.previewMode` is `"decoration"`).                                                                                                                                                                                                           |
| `insertseq.previewStatus`     | boolean | `true`                         | Show live preview of insertions while typing.                                                                                                                                                                                                                                                     |
| `insertseq.previewDebounce`   |  number | `60`                           | Debounce delay in milliseconds before calculating sequence previews during rapid keystrokes (0 to disable).                                                                                                                                                                                       |
