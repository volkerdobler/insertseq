...
- Create a `WHATSNEW-<version>.md` file only for releases that contain user-relevant changes, migration notes, or important behavioral changes. Minor bugfix-only releases do not require a WHATSNEW file.
